...
function setup() {
	...
	packageBody = Bodies.circle(width/2 , 200 , 5 ,pack_opt );
	World.add(world, packageBody);
	
	redbox2body = Bodies.rectangle(width/2, 650, 200, 20 , {isStatic:true} );
	World.add(world,redbox2body);

	redbox3body = Bodies.rectangle(width/2, 650, 200, 20 , {isStatic:true} );
